...
import { Config, Game } from "../entities/entities";
...
export const IMAGES_MOCK: string[] = [
...
export const SLIDE_IMAGES_AUTH: Record<string, string> = {
  "0": "The best free games wiki",
  "1": "Share with your friends",
  "2": "Stay up to date with the latest news",
};

export const ASSETS_IMAGE: string = "test-image";

export const REQUEST_GAMES_MOCK: Game[] = [
  {
    id: 582,
    title: "Tarisland",
