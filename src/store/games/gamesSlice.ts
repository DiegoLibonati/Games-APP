...
import { GamesPayload, GamesState } from "../../entities/entities";
...
export const gamesSlice = createSlice({
  ...
  reducers: {
    ...
    setHomeCard: (
      state,
      action: PayloadAction<GamesPayload["setHomeCard"]>
    ) => {
    ...
    setGamesSliderOne: (
      state,
      action: PayloadAction<GamesPayload["setGamesSliderOne"]>
    ) => {
      ...
      state.gamesSliders.gamesSliderCategoryOne.isGamesSlidersLoadingOne =
        false;
    },
    setGamesSliderTwo: (
      state,
      action: PayloadAction<GamesPayload["setGamesSliderTwo"]>
    ) => {
      ...
      state.gamesSliders.gamesSliderCategoryTwo.isGamesSlidersLoadingTwo =
        false;
    },
    setGamesSliderTr: (
      state,
      action: PayloadAction<GamesPayload["setGamesSliderTr"]>
    ) => {
    ...
    setHomeCardsWithInformation: (
      state,
      action: PayloadAction<GamesPayload["setHomeCardsWithInformation"]>
    ) => {
    ...
    setNewGameToFavoriteGames: (
      state,
      action: PayloadAction<GamesPayload["setNewGameToFavoriteGames"]>
    ) => {
      state.favoriteGames.favoriteGamesArray.push(action.payload);
    },
    setAlertFavoriteGame: (
      state,
      action: PayloadAction<GamesPayload["setAlertFavoriteGame"]>
    ) => {
    ...
    resetAlertFavoriteGame: (state) => {
      state.alertFavoriteGame.type = undefined;
      state.alertFavoriteGame.message = "";
      state.alertFavoriteGame.isLoadingAlert = false;
    },
    setFavoriteGames: (
      state,
      action: PayloadAction<GamesPayload["setFavoriteGames"]>
    ) => {
      state.favoriteGames.isFavoriteGamesLoading = true;
    ...
    deleteFavoriteGame: (
      state,
      action: PayloadAction<GamesPayload["deleteFavoriteGame"]>
    ) => {
      state.favoriteGames.favoriteGamesArray =
    ...
    setActiveGame: (
      state,
      action: PayloadAction<GamesPayload["setActiveGame"]>
    ) => {
    ...
    setAllGames: (
      state,
      action: PayloadAction<GamesPayload["setAllGames"]>
    ) => {
      state.allGames.isAllGamesArrayLoading = true;
