...
import { ASSETS_IMAGE } from "../../../tests/jest.setup";
...
describe("If isNavBarOpen is 'true'.", () => {
  ...
  test("It must render the nav with the relevant classes.", () => {
    ...
    expect(nav).toHaveClass("header_container_nav navbar_open");
  });
});
...
describe("If isNavBarOpen is 'false'.", () => {
  ...
  test("It must render the nav with the relevant classes.", () => {
    ...
    expect(nav).toBeInTheDocument();
    expect(nav).toHaveClass("header_container_nav");
  });
});
...
describe("General Tests.", () => {
  ...
  test("It must render the logo and the hamburger.", () => {
    ...
    expect(img).toHaveAttribute("src", ASSETS_IMAGE);
  ...
  test("It must render the username.", () => {
    ...
    const headingUsername = screen.getByRole("heading", { name: displayName });
